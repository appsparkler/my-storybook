...
const OutTextField = ({ outTextField }) => (
  <DateTimeTextField {...outTextField} />
)
...
const ScheduledSlots = ({ items, onDeleteSlot, onChangeSlot }) => {
