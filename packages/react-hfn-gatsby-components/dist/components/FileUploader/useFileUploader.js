...
var useFileUploader = function useFileUploader(_ref) {
  var storagePath = _ref.storagePath,
  ...
  var uploadFiles = _react["default"].useCallback( /*#__PURE__*/function () {
            ...
            case 0:
              filesWithUUID = _toConsumableArray(files).map(function (file) {
                return _objectSpread(_objectSpread({}, file), {}, {
                  name: "".concat(_uuid["default"].v4(), "-").concat(file.name)
                });
              });
